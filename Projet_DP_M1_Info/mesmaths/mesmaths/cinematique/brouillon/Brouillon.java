...
{
	/**
	 * gestion de la collision dynamique (avec rebond) ou statique  de la bille definie par (position, rayon, vitesse, acc�l�ration) avec le segment orient� [P0P1]
	 * 
	 * @return l'intensit� du choc. Si la valeur retournee est > 0 alors il y a choc, si la valeur retourn�e est <= 0 alors il n'y a pas de choc. 
	...
	static double actionReactionBilleSegmentAvecRebond( Vecteur position, double rayon, Vecteur vitesse, Vecteur acceleration, double masse, Vecteur P0, Vecteur P1)
	{
		...
		acceleration.ajoute(a.produit(alfabar));
