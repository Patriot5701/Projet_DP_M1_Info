...
/**
 * Represente la ligne des cases a cocher pour le choix du son pour la bille hurlante.
 * 
...
public class PanneauChoixHurlement extends Panel
{
	 ...
	 * @param choixHurlementInitial : hurlement choisi par defaut a l'initialisation de l'application. 
