...
public class MesMaths
{
	 ...
	 * 
	 * si les solutions sont reelles, elles sont class�es par ordre croissant telles que t[0] < = t[1]
	 * 
	 * */
	public static Object [] resoutEquationDegre2(double a, double b, double c)
	{
		if (a == 0) throw new ArithmeticException("l'equation a resoudre n'est pas du 2eme degre");
	...
	public static double[] resoutEquationDegre3Reduite(double p, double q)
	{
		...
		if (XY[0] instanceof Double) /* les solutions sont reelles : il y a donc une solution a l'equation */
		{
			t = new double[1];
	...
	/**
	 * r�sout dans R, par la methode de Cardan, l'equation a3*t^3 + a2*t^2 + a1*t + a0 = 0
	 * 
	...
	public static double [] resoutEquationDegre3(double a0, double a1, double a2, double a3)
	{
		...
		// on a reduit l'equation a : t^3 + A * t^2 + B * t + C = 0
	...
	{
		if (a == 0) throw new ArithmeticException("l'equation a resoudre n'est pas du 1er degre");
