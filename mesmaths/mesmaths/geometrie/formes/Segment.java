...
public class Segment extends ArcCourbe
{
	...
	@Override
	public double projeteOrthogonal(Vecteur p)
	{
		double t = Vecteur.difference(p, P0).produitScalaire(base[0])/this.P0P1;

		if ( !(0 <= t && t <=1) ) throw new ExceptionGeometrique("l'abscisse curviligne de " + p +" n'est pas d�fini pour le segment [ "+ P0+" "+ P1+"]");
		return t;
	}
